    ...
    <div className="min-h-screen bg-[#F7F9FC] py-20 px-6">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-6 items-center">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          <h2 className="text-3xl font-bold text-black">Rp0<span className="text-sm font-normal"> /month</span></h2>
          <h3 className="mt-4 text-lg text-gray-800 font-semibold">Free</h3>
          <p className="text-gray-500 text-sm mt-2">
            Great for individuals and small brands exploring influencer campaigns at no cost.
          </p>
        ...
        {/* BASE */}
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          <h2 className="text-3xl font-bold text-black">Rp89,000<span className="text-sm font-normal"> /month</span></h2>
        ...
        <div className="relative rounded-2xl p-8 text-white shadow-xl bg-gradient-to-b from-[#006FFF] to-[#4DA3FF] scale-105">
          ...
          <h2 className="text-3xl font-bold">Rp119,000<span className="text-sm font-normal"> /month</span></h2>
        ...
        {/* ENTERPRISE */}
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          <h2 className="text-3xl font-bold text-black">Rp249,000<span className="text-sm font-normal"> /month</span></h2>
